...
const copy: Record<PageKey, { title: string; body: string[] }> = {
  ...
  terms: {
    ...
    body: [
      ...
      "If activated, a Sprint Pass is a one-time purchase for the identified annual season and does not automatically renew. The price, included features, refund terms, and access period will be shown before checkout. Payments remain disabled until the owner completes payment and legal readiness checks.",
      ...
      "Tennessee law governs these Terms without regard to conflict-of-law rules. Before filing a claim, contact OnaolapoAdeyemi@gmail.com so both parties can attempt an informal resolution. Additional dispute language may be added before paid public launch following legal review.",
    ],
  },
  guidelines: {
